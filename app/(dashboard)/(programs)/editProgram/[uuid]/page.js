        ...
        <div className="rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="py-6 px-4 md:px-6 xl:px-7.5 space-y-4 ">
            ...
            >
              ...
              <div className="mt-3">
                <label className="mb-2.5 block font-medium text-black dark:text-white">
                  Program expire date (Optional)
                </label>
                <input
                  type="date"
                  name="expireDate"
                  defaultValue={
                    program.expireDate ? program.expireDate.split("T")[0] : ""
                  }
                  className="border-stroke w-full rounded"
                />
                ...
                {fields.map((item, index) => (
                  <div className="text-black flex space-x-1" key={item}>
                    <div className="font-bold">
                      {index + program.ProgramRequirements.length + 1}.
                    </div>
                    <div>{item}</div>
                    <div
                      className="cursor-pointer"
              ...
              <button
                type="submit"
                className="py-2 px-3 rounded justify-center flex bg-primary text-white"
              >
