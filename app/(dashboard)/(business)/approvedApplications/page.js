        ...
        >
          ...
          <div onClick={()=>{
                  ...
                  setSelectedBusiness(null)
                   ...
                   Options
                   <div className={`absolute z-9 z-9 transition-all ${ShowOptions == item.uuid?" scale-100 ":" scale-0 "} -translate-x-4 bg-white shadow-lg   left-0 w-40 space-y-2 rounded-lg py-2 px-4 top-10`}>
                    {[
