...
import {getSectorBusinesses} from "../../../../controllers/sector_controller"
...
const Page = ({params}) => {
  ...
  useEffect(() => {
        getSectorBusinesses(params.uuid).then((data)=>{
    ...
    <div>
        <Breadcrumb pageName="Ventures" prevLink={"/sectors"} prevPage="Sectors" />
      <div className="rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="py-6 px-4 md:px-6 xl:px-7.5">
        <h4 className="text-xl font-semibold text-black dark:text-white">
         {applications.length}  Ventures available
        </h4>
      </div>
