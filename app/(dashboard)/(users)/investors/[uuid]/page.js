  ...
  const contactSection = {
    ...
    items: [
      ...
      },
      {
        icon: <HiOutlineDocumentText className="w-5 h-5" />,
        label: "LinkedIn",
        value: user.InvestorProfile?.linkedIn ? (
          <a
            href={user.InvestorProfile.linkedIn}
            target="_blank"
  ...
  const investmentSection = {
    ...
    items: [
      ...
      },
      {
        ...
        value: user.InvestorProfile?.structure || "Not specified",
      },
      {
        icon: <HiOutlineDocumentText className="w-5 h-5" />,
        label: "Investment Focus",
        value: user.InvestorProfile?.focus?.join(", ") || "Not specified",
      },
      {
        icon: <HiOutlineDocumentText className="w-5 h-5" />,
  ...
  const bioSection = {
    ...
    items: [
      ...
      },
      {
        ...
        value: user.InvestorProfile?.notableInvestments || "Not provided",
      },
    ],
  };
                ...
                {bioSection.items.map((item, itemIndex) => (
                  <div key={itemIndex} className="flex items-start gap-3">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="text-base font-medium text-black dark:text-white whitespace-pre-wrap">
                        {item.value}
                      </div>
                    </div>
                  </div>
