...
const FinancialInformation = () => {
    ...
    return ( <div className="py-6 px-8">
        <div className="font-bold text-2xl text-black mb-4">Financial documents</div>
        <form onSubmit={(e)=>{
           e.preventDefault()
           const data = {
        ...
        {userDetails.Business.BusinessDocuments.filter((item)=>item.type =="financialInformation").map((item)=>  {
            return <div className="p-4 flex rounded shadow cursor-pointer text-center border border-stroke flex-col justify-center items-center text-lg font-bold">
