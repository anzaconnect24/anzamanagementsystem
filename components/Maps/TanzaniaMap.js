...
const TanzaniaMap = () => {
        ...
        response.data.forEach((user) => {
          try {
            if (
              ...
              regionData[user.Business.location]
            ) {
  ...
  const { totalEntrepreneurs, maxCount, sortedRegions } = useMemo(() => {
    ...
    const sorted = Object.entries(mapData).sort(
      ([, a], [, b]) => b.count - a.count
    );
        ...
        <div className="flex items-center justify-center h-[400px]">
          <div className="text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              {t(
                "dashboard.loadingEntrepreneurData",
    ...
    return (
      <div className="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
        <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap mb-6">
          <div>
            <h3 className="text-xl font-bold text-black dark:text-white">
              {t(
                "dashboard.entrepreneurDistribution",
        ...
        <div className="flex flex-col items-center justify-center h-[400px] text-center">
          ...
          <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">
            {t(
              "dashboard.noEntrepreneurDataFound",
      ...
      return (
        <div className="flex items-center justify-center h-full bg-gray-100 dark:bg-boxdark-2 rounded-sm">
          <div className="text-center">
            <div className="animate-spin h-8 w-8 border-4 border-primary border-t-transparent rounded-full mx-auto mb-2"></div>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {t("dashboard.loadingMap", "Loading map...")}
            </p>
          </div>
        </div>
      );
      ...
      return (
        <div className="flex items-center justify-center h-full bg-gray-100 dark:bg-boxdark-2 rounded-sm">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {t(
                "dashboard.mapComponentsUnavailable",
                "Map components unavailable"
              )}
            </p>
          </div>
        </div>
