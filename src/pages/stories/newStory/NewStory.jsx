...
import { createSector } from "@/controllers/sector_controller";
...
import { getApprovedBusinesses } from "@/controllers/business_controller";
import { createSuccessStory } from "@/controllers/stories_controller";
          ...
          >
            <div className="w-full flex flex-col items-center justify-center">
              <input
                ...
                name="image"
                id="image"
                className="w-full rounded border-stroke sr-only"
              />
              {imageURL == null ? (
                <div>
                  <label htmlFor="image">
            ...
            <div className="grid grid-cols-2 gap-x-3 mt-6">
              ...
              <div>
                ...
                <select
                  ...
                  disabled={userDetails.role == "Enterprenuer"}
                  className="w-full rounded border-stroke"
