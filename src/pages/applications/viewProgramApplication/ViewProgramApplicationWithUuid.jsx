        ...
        <div className="py-6 px-4 md:px-6 xl:px-7.5">
          <div className="space-y-3">
            {[
              { title: "Application for", value: application.Program.title },
              {
                ...
                value: timeAgo(application.createdAt),
              },
                  ...
                  {application.ProgramApplicationDocuments.map((item, key) => {
                    return (
                      <a
                        ...
                        href={item.fileLink}
                        target="_blank"
                        className="w-full py-4 cursor-pointer text-center flex flex-col items-center justify-center  px-4 border border-stroke rounded hover:shadow"
                      >
                        <svg
          ...
          {application.status == "waiting" && (
            <div className="flex space-x-3  pt-8">
              ...
              <Link
                href={`/programApplicationRejection/${uuid}`}
