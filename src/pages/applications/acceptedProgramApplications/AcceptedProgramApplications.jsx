...
import { getAcceptedProgramApplications } from "@/controllers/program_application_controller";
...
const Page = () => {
  ...
  useEffect(() => {
    ...
    return applications && (
    <div>
      <Breadcrumb prevLink={``} prevPage="Programs" pageName="Accepted applications" />
