...
const Page = () => {
  ...
  const handleInterestClick = (businessUuid) => {
    ...
    toast.promise(sendInvestmentInterest(data), {
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="flex items-center bg-white dark:bg-boxdark rounded-xl border border-stroke dark:border-strokedark">
              ...
              >
                ...
                >
                  <path
                    d="M8.74992 1.25H1.24992C1.05991 1.25 0.877542 1.32902 0.744063 1.46249C0.610584 1.59597 0.531563 1.77834 0.531563 1.96835V9.46835C0.531563 9.65836 0.610584 9.84073 0.744063 9.97421C0.877542 10.1077 1.05991 10.1867 1.24992 10.1867H8.74992C8.93993 10.1867 9.1223 10.1077 9.25578 9.97421C9.38926 9.84073 9.46828 9.65836 9.46828 9.46835V1.96835C9.46828 1.77834 9.38926 1.59597 9.25578 1.46249C9.1223 1.32902 8.93993 1.25 8.74992 1.25ZM7.96828 8.68671H2.03156V2.75H7.96828V8.68671Z"
                    fill="currentColor"
                  ></path>
                  <path
                    d="M18.7499 1.25H11.2499C11.0599 1.25 10.8775 1.32902 10.7441 1.46249C10.6106 1.59597 10.5316 1.77834 10.5316 1.96835V9.46835C10.5316 9.65836 10.6106 9.84073 10.7441 9.97421C10.8775 10.1077 11.0599 10.1867 11.2499 10.1867H18.7499C18.9399 10.1867 19.1223 10.1077 19.2558 9.97421C19.3892 9.84073 19.4683 9.65836 19.4683 9.46835V1.96835C19.4683 1.77834 19.3892 1.59597 19.2558 1.46249C19.1223 1.32902 18.9399 1.25 18.7499 1.25ZM17.9683 8.68671H12.0316V2.75H17.9683V8.68671Z"
                    fill="currentColor"
                  ></path>
                  <path
                    d="M8.74992 11.25H1.24992C1.05991 11.25 0.877542 11.329 0.744063 11.4625C0.610584 11.596 0.531563 11.7783 0.531563 11.9683V19.4683C0.531563 19.6584 0.610584 19.8407 0.744063 19.9742C0.877542 20.1077 1.05991 20.1867 1.24992 20.1867H8.74992C8.93993 20.1867 9.1223 20.1077 9.25578 19.9742C9.38926 19.8407 9.46828 19.6584 9.46828 19.4683V11.9683C9.46828 11.7783 9.38926 11.596 9.25578 11.4625C9.1223 11.329 8.93993 11.25 8.74992 11.25ZM7.96828 18.6867H2.03156V12.75H7.96828V18.6867Z"
                    fill="currentColor"
                  ></path>
                  <path
                    d="M18.7499 11.25H11.2499C11.0599 11.25 10.8775 11.329 10.7441 11.4625C10.6106 11.596 10.5316 11.7783 10.5316 11.9683V19.4683C10.5316 19.6584 10.6106 19.8407 10.7441 19.9742C10.8775 20.1077 11.0599 20.1867 11.2499 20.1867H18.7499C18.9399 20.1867 19.1223 20.1077 19.2558 19.9742C19.3892 19.8407 19.4683 19.6584 19.4683 19.4683V11.9683C19.4683 11.7783 19.3892 11.596 19.2558 11.4625C19.1223 11.329 18.9399 11.25 18.7499 11.25ZM17.9683 18.6867H12.0316V12.75H17.9683V18.6867Z"
                    fill="currentColor"
                  ></path>
                </svg>
              </button>
              ...
              >
                ...
                >
                  <path
                    d="M1.5625 3.125H18.4375M1.5625 10H18.4375M1.5625 16.875H18.4375"
                    stroke="currentColor"
                    strokeWidth="1.875"
                    strokeLinecap="round"
      ...
      {filteredApplications.length < 1 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredApplications.map((item, key) => (
            <div
              key={key}
              className="bg-white dark:bg-boxdark rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden h-full flex flex-col"
            >
              {/* Card Header */}
