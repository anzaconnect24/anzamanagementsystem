"use client";
import { deleteProgram, getProgram } from "@/controllers/program_controller";
          ...
          <div className="py-6 px-4 md:px-6 xl:px-7.5">
            ...
            {program.applied == 0 && userDetails.role != "Admin" && (
              <div className="flex mt-5">
                <Link
                  href={`/sendProgramApplication/${program.uuid}`}
                  className="py-3 px-4 bg-primary 
        rounded hover:opacity-95 text-white mt-3 "
                >
                  Apply to program
                </Link>
              </div>
