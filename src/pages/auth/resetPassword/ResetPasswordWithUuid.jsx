...
const Page = ({ params }) => {
  ...
  const handleSubmit = (values) => {
    const data = { ...values };
    setisLoading(true);
    newPassword({ password: values.password }, uuid).then((data) => {
  ...
  return (
    <>
      <div className="rounded-lg border border-stroke bg-white min-w-screen dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap ">
          <div className="w-full     mx-auto  xl:w-1/2  ">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block text-center text-primary font-bold">
                New password
              </span>
                ...
                {({ handleSubmit, handleChange, values, touched, errors }) => (
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-6">
                      ...
                      <p className=" text-danger pt-3">{errors.confirmation}</p>
                    </div>
