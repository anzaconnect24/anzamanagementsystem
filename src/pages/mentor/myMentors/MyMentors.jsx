...
const MentorEntreprenuer = () => {
  ...
  const handleAcceptAppointment = async (application) => {
    ...
    try {
      ...
      const res = await getEntreprenuerMentors(userDetails.uuid, 1, 100, "");
      setData(res);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] px-6 py-6">
      <div className="mx-auto max-w-7xl">
                  ...
                  <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-sm text-[#667085]">
                        {new Date(application.appointmentDate).toLocaleString()}
                      </p>
                      ...
                      <a
                        ...
                        className="mt-3 inline-block text-sm font-medium text-[#2563EB]"
                      >
                        View Meeting Link
                      </a>
                    </div>
                    ...
                    <button
                      ...
                      className="rounded-xl bg-[#16A34A] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#15803D]"
                    >
        ...
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-[#101828]">My Mentors</h2>
        </div>
            ...
            {data.map((application, key) => {
              ...
              return (
                <Link
                  ...
                  className="group"
                >
                  <div className="overflow-hidden rounded-3xl border border-[#EAECF0] bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute bottom-4 left-4">
                        <span className="rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-[#101828] backdrop-blur-sm">
                          {item?.MentorProfile?.expertise || "Business Mentor"}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col p-6">
                      <div className="flex-1">
                        <h3 className="text-xl font-bold text-[#101828] transition group-hover:text-[#2563EB]">
                          {getMentorName(item)}
                        </h3>
                      ...
                      <div className="mt-6 border-t border-[#EAECF0] pt-5">
                        <button className="w-full rounded-xl bg-[#2563EB] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#1D4ED8]">
                          View Profile
                        </button>
                      </div>
                    </div>
