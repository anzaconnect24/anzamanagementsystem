...
const Services = () => {
  ...
  return (
    <div className="py-6 px-8">
      <div className="font-bold text-2xl text-black mb-4">
      ...
      >
        ...
        <div>
          ...
          >
            <div>
              {uploadingDocument ? <Spinner /> : "Upload service/product"}
            </div>
          </button>
        </div>
      </form>
      <div className="grid grid-cols-3 gap-4 mt-8">
        {userDetails.Business.BusinessDocuments.filter(
          ...
          return (
            <div
              key={key}
              className="p-4 flex rounded shadow cursor-pointer text-center border border-stroke flex-col justify-start items-center text-lg font-bold"
            >
              <div>
                <Image
                  src={item.link}
